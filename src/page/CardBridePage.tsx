...
export default function CardBridePage() {
  ...
  // Countdown for bride's reception: 18/01/2026 10:30
  useEffect(() => {
    const target = new Date('2026-01-18T10:30:00').getTime()
    const tick = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fdfcf9] text-[#4a4a4a]">
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-sm sm:text-base text-[#8a8a8a] mb-8 lg:mb-12">
              (Nhằm ngày 29 tháng 11 năm Ất Tỵ)
            </p>
      ...
      {/* ══════════════════════════════════════════════════════════════════
          EVENT SECTION - Only Reception for Bride's Guests
      ══════════════════════════════════════════════════════════════════ */}
        <section className="py-16 lg:py-24 px-6 bg-white">
        <div className="max-w-4xl mx-auto">
          <motion.div
          ...
          <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
            ...
            >
              ...
              <p className="text-xs text-[#8a8a8a] mb-1">
                Thôn Mỹ Yên, Đức Lập, ĐăkNông
              </p>
              <p className="text-xs text-[#8a8a8a] italic mb-6">
                (Nhằm ngày 29/11 Ất Tỵ)
              </p>
              <button
                onClick={() => window.open('https://www.google.com/maps/place/Nh%C3%A0+H%C3%A0ng+Di%E1%BB%87u+Hoa/@12.4383154,107.6301538,17z/data=!3m1!4b1!4m6!3m5!1s0x317247d5cd8f98a1:0x7b1cf938fa16c514!8m2!3d12.4383102!4d107.6327287!16s%2Fg%2F11hzh3kktz?entry=ttu&g_ep=EgoyMDI1MTIwOS4wIKXMDSoASAFQAw%3D%3D', '_blank')}
