    ...
    <div className="min-h-screen bg-white antialiased">
      ...
      <section className="relative py-16 sm:py-20 md:py-24 lg:py-32 bg-gradient-to-b from-white via-gray-50/30 to-white overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1.2fr_minmax(0,_0.6fr)_1.2fr] gap-12 sm:gap-16 md:gap-20 items-stretch">
            {/* Chú rể */}
            <motion.div
            ...
            >
              ...
              >
                <span className="block">Phêrô</span>
            ...
            {[
              {
                ...
                address: 'Nhà thờ Giáo xứ Vinh An',
                map: 'https://www.google.com/maps/place/Vinh+An+Parish+Church/@12.4285939,107.6351848,17z/data=!3m1!4b1!4m6!3m5!1s0x317247bb1ac930b7:0xfb22730300d69aa4!8m2!3d12.4285887!4d107.6377597!16s%2Fg%2F11h04mbm1?entry=ttu&g_ep=EgoyMDI1MTIwOS4wIKXMDSoASAFQAw%3D%3D',
                note: '(Nhằm ngày 28/11 năm Ất Tỵ)'
              },
              {
                title: 'Tiệc Cưới',
                subtitle: 'Tiệc mừng',
                date: '18 Tháng 01, 2026',
                time: '10:30',
                location: 'Nhà hàng tiệc cưới Tuấn Thảo 2',
                address: 'Thôn Xuân Phong - Xã Đức Lập - Tỉnh Lâm Đồng',
                map: 'https://www.google.com/maps/place/Nh%C3%A0+H%C3%A0ng+Nh%C6%B0+%C3%9D/@12.4329574,107.6542266,3a,90y,222.31h,89.33t/data=!3m7!1e1!3m5!1sXNq-qLAbN3q8jpT4omGPAA!2e0!6shttps:%2F%2Fstreetviewpixels-pa.googleapis.com%2Fv1%2Fthumbnail%3Fcb_client%3Dmaps_sv.tactile%26w%3D900%26h%3D600%26pitch%3D0.6732719742792597%26panoid%3DXNq-qLAbN3q8jpT4omGPAA%26yaw%3D222.30693783743888!7i16384!8i8192!4m14!1m7!3m6!1s0x317247bb1ac930b7:0xfb22730300d69aa4!2sVinh+An+Parish+Church!8m2!3d12.4285887!4d107.6377597!16s%2Fg%2F11h04mbm1!3m5!1s0x317247e8bb859ccb:0xcb28db61f2a53af9!8m2!3d12.4328215!4d107.6541134!16s%2Fg%2F11h1l0s5nv?entry=ttu&g_ep=EgoyMDI1MTIwOS4wIKXMDSoASAFQAw%3D%3D',
                note: '(Nhằm ngày 30/11 năm Ất Tỵ)'
              }
            ].map((event, index) => (
              <motion.div
                key={index}
      ...
      <section className="relative py-20 sm:py-24 md:py-32 lg:py-40 bg-black text-white overflow-hidden">
        {/* subtle background gradient */}
        <div className="absolute inset-0 bg-gradient-to-b from-black via-gray-900 to-black" />
        {/* top & bottom highlight lines */}
        <div className="pointer-events-none absolute top-0 left-1/2 h-px w-full max-w-5xl -translate-x-1/2 bg-gradient-to-r from-transparent via-white/30 to-transparent" />
        <div className="pointer-events-none absolute bottom-0 left-1/2 h-px w-full max-w-5xl -translate-x-1/2 bg-gradient-to-r from-transparent via-white/20 to-transparent" />
\n        <div className="relative z-10 max-w-3xl mx-auto px-6 sm:px-8 text-center space-y-6 sm:space-y-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div className="flex items-center justify-center gap-4 sm:gap-6 mb-6">
              <div className="h-px w-12 sm:w-16 md:w-20 bg-gradient-to-r from-transparent via-white/35 to-white/45" />
              <span className="text-white/70 text-xl sm:text-2xl">♡</span>
              <div className="h-px w-12 sm:w-16 md:w-20 bg-gradient-to-r from-white/45 via-white/35 to-transparent" />
            </div>
            <h2
              className="text-2xl sm:text-3xl md:text-4xl font-light mb-6 sm:mb-8"
              style={{ fontFamily: 'serif', letterSpacing: '-0.02em' }}
            >
              Hạnh phúc trọn vẹn khi được sẻ chia
            </h2>
            <div className="space-y-3 sm:space-y-4 text-sm sm:text-base md:text-lg text-white/85 font-light leading-relaxed">
              <p>Hạnh phúc sẽ trở nên trọn vẹn hơn</p>
              <p>khi được sẻ chia cùng những người thân thương.</p>
              <p>Sự hiện diện của bạn chính là niềm vui lớn</p>
              <p>và là lời chúc phúc ý nghĩa nhất dành cho chúng tôi.</p>
            </div>
          </motion.div>
        </div>
      </section>
